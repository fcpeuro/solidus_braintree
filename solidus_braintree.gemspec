...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'braintree', '~> 4'
  spec.add_dependency 'solidus_api', ['>= 2.3.0', '< 5']
  spec.add_dependency 'solidus_core', ['>= 2.3.0', '< 5']
  spec.add_dependency 'solidus_support', ['>= 0.4.1', '< 1']
